    ...
    return (
        <div className={LightStyles.header}>
            <div className={LightStyles.logo}>
                <NavLink className={LightStyles.logoNavLink} to='/home'>V2EX</NavLink>
            </div>
            <div className="menu">
                <NavLink className={LightStyles.menuNavLink} activeClassName={LightStyles.menuNavLinkActive} to='/home'>首页</NavLink>
