        ...
        <div className={Styles.pageItem}>
           <div className={Styles.item}>
                ...
                <div className={Styles.info}>
                    <NavLink className={Styles.title} to={'/topic/'+props.id}>{props.title}</NavLink>
                    <div>
                        <span className={Styles.tag}>
                            <NavLink to='/' className={Styles.tagLink}>{props.nodeName}</NavLink>
                        </span>
                        <span className={Styles.author}>
                            <NavLink to={'/member/' + props.userName} className={Styles.authorLink}>{props.userName}</NavLink>
                        </span>
